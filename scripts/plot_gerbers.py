...
plot_plan = [
    ( "CuTop", F_Cu, "Top layer", "-Front.gtl"),
    ( "CuBottom", B_Cu, "Bottom layer", "-Back.gbl"),
    ( "MaskBottom", B_Mask, "Mask Bottom", "-B_Mask.gbs"),
    ( "MaskTop", F_Mask, "Mask top", "-F_Mask.gts"),
    ( "PasteBottom", B_Paste, "Paste Bottom", "-B_Paste.gbp"),
    ( "PasteTop", F_Paste, "Paste Top", "-F_Paste.gtp"),
    ( "SilkTop", F_SilkS, "Silk Top", "-F_SilkS.gto"),
    ( "SilkBottom", B_SilkS, "Silk Bottom", "-B_SilkS.gbo"),
    ( "EdgeCuts", Edge_Cuts, "Edges", "-Edge_Cuts.gm1")
]
...
dstPlot = os.path.join(output_directory,project_name + '.drl')
shutil.move(srcPlot, dstPlot)
...
#zip up all files
zf = zipfile.ZipFile(os.path.join(output_directory,project_name + '_' + 'gerbers' + '.zip'), "w", zipfile.ZIP_DEFLATED)
